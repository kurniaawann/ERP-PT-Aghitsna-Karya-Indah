...
use App\Models\Invoice\InvoiceProyek;
use App\Models\Invoice\PaymentAccount;
use App\Exports\Invoice\ProyekInvoiceExport;
...
class ProyekInvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.invoice.proyek-invoice', compact('invoices', 'paymentAccounts'));
    }
