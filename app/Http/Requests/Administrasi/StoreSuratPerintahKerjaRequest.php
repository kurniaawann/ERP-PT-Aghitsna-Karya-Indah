...
/**
 * Form Request untuk validasi data Surat Perintah Kerja (SPK) saat penyimpanan (create).
 *
...
class StoreSuratPerintahKerjaRequest extends FormRequest
{
    ...
    /**
     * Mendefinisikan aturan validasi untuk penyimpanan surat perintah kerja.
     *
