...
/**
 * Form Request untuk validasi data bukti kas keluar saat proses penyimpanan (create).
 *
 * Kelas ini bertanggung jawab atas validasi input dari form tambah bukti kas keluar.
 * Validation rules didefinisikan di sini agar terpisah dari Controller (Single Responsibility).
 */
class StoreCashOutProofRequest extends FormRequest
{
    /**
    ...
    /**
     * Mendefinisikan aturan validasi untuk penyimpanan bukti kas keluar.
     *
