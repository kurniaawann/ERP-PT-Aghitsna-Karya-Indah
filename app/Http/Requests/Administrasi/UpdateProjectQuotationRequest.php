...
class UpdateProjectQuotationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items_mode' => 'nullable|in:items,text',
            'free_text' => 'nullable|string|required_if:items_mode,text',
    ...
    public function messages(): array
    {
        return [
            ...
            'items.*.keterangan' => 'Keterangan item wajib diisi.',
            'items.*.harga' => 'Harga item wajib diisi.',
            'free_text.required_if' => 'Deskripsi teks wajib diisi saat memilih mode teks.',
