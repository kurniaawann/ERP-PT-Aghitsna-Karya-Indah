...
/**
 * Form Request untuk validasi data surat jalan saat proses pembaruan (update).
 *
 * Kelas ini bertanggung jawab atas validasi input dari form edit surat jalan.
...
class UpdateDeliveryNoteRequest extends FormRequest
{
    ...
    /**
     * Mendefinisikan aturan validasi untuk pembaruan surat jalan.
     *
