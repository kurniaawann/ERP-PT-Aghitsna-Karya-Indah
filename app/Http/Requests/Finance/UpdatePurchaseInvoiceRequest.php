...
/**
 * Form Request untuk validasi update Faktur Pembelian.
 *
 * Sama dengan StorePurchaseInvoiceRequest, namun digunakan
 * untuk operasi update pada faktur yang sudah ada.
 */
class UpdatePurchaseInvoiceRequest extends FormRequest
{
    ...
    /**
     * Aturan validasi untuk update Faktur Pembelian.
     *
