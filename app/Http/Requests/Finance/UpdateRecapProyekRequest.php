...
/**
 * Form Request untuk validasi update Rekap Proyek.
 *
 * File design bersifat opsional pada update; kosongkan untuk
 * mempertahankan file yang sudah ada.
 */
class UpdateRecapProyekRequest extends FormRequest
{
    /**
