...
/**
 * Form request for updating an existing employee.
 *
 * The employee_code is not validated here since it is identified via route model
 * binding. All other fields are validated to ensure data integrity.
 */
