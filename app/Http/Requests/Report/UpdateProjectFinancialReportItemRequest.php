...
/**
 * Form Request untuk validasi update item "Bon" Laporan Keuangan Proyek.
 *
 * File bukti pembayaran bersifat opsional pada update; kosongkan untuk
 * mempertahankan file yang sudah ada.
 */
class UpdateProjectFinancialReportItemRequest extends FormRequest
{
    /**
