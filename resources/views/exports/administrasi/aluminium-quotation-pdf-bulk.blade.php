...
<body>
    @foreach ($quotations as $loop_idx => $q)
        @php
            $groups = $q->groups;
        ...
        <div class="{{ !$loop->last ? 'page-break' : '' }}">
            <div class="header">
                <div class="header-left">
                    <div class="logo-wrap">
                        <div class="logo-img"><img src="{{ public_path('images/logo.jpeg') }}" alt="Logo"></div>
            ...
            <div class="opening">Dengan ini kami sampaikan Penawaran Harga, sebagai berikut :</div>
