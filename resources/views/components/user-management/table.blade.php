                    ...
                    @forelse($users as $user)
                        <tr class="border-t hover:bg-surface-secondary">
                            ...
                            <td class="p-2 text-center">
                                @if ($user->id === auth()->id())
                                    <span
                                        class="px-2 py-1 text-xs rounded-full font-medium opacity-50 cursor-not-allowed
                                ...
                                @else
                                    <button type="button"
                                        onclick="document.getElementById('toggleForm-{{ $user->id }}').submit()"
                                        class="px-2 py-1 text-xs rounded-full font-medium cursor-pointer transition-colors
