...
<x-modal id="editModal-{{ $category->id }}" title="Edit Kategori Transaksi"
    ...
    <div class="mb-3">
        ...
        <input type="text" value="{{ $category->id }}" class="w-full border rounded p-2 bg-gray-100 cursor-not-allowed"
            readonly>
        <p class="text-xs text-gray-500 mt-1">ID Kategori tidak dapat diubah</p>
    </div>
