{{-- Modal Edit Invoice Semen (satu modal tunggal, diisi via AJAX) --}}
<x-modal id="editModal" title="Edit Invoice Semen" action="#" method="PUT" buttonText="Update"
    size="6xl" formId="editSemenForm">

    <input type="hidden" id="edit-invoice-number" value="">
    <input type="hidden" name="invoice_number" id="edit-invoice-number-hidden" value="">

    <div class="mb-3">
        <label class="block text-text-primary mb-1">No Invoice</label>
        <input type="text" id="edit-invoice-number-display" class="w-full border rounded p-2 bg-surface-hover cursor-not-allowed"
            readonly>
    ...
    <div class="mb-3">
        ...
        <textarea name="note" id="edit-invoice-note" rows="2" class="w-full border rounded p-2"
            placeholder="Catatan tambahan (opsional)"></textarea>
    </div>
    <div id="edit-semen-projects-container">
        <div class="flex items-center justify-between mb-2">
            <label class="block text-text-primary font-semibold">Proyek &amp; Data Semen <span
                    class="text-error">*</span></label>
            <button type="button" id="add-project-btn-edit"
        ...
        <div id="edit-semen-project-list" class="space-y-4"></div>
    </div>
    ...
    <div class="mb-4 p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border-2 border-primary/20">
        <div class="flex justify-between items-center">
            ...
            <span id="edit-invoice-total-preview" class="text-2xl font-bold text-primary">Rp 0</span>
        </div>
    </div>

    <input type="hidden" name="projects" id="edit-semen-projects-json" value="[]">

    {{-- Template Proyek (disalin oleh JS) --}}
    <template id="edit-semen-project-template">
        <div class="semen-project p-3 border rounded bg-surface-secondary">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
                <div>
                    <label class="block text-text-label text-sm mb-1">Nama Proyek <span
                            class="text-error">*</span></label>
    ...
    <template id="edit-semen-row-template">
        <tr class="semen-row">
