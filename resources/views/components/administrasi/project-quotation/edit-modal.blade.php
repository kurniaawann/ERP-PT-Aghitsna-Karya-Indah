...
<x-modal id="editModal-{{ $quotNum }}" title="Edit Penawaran Proyek"
    ...
    <div class="space-y-5">
        ...
        <div class="bg-blue-50 rounded-lg p-3 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs text-gray-500">Nomor Penawaran</p>
        ...
        <div>
            ...
            <input type="date" name="date" class="w-full border rounded-lg p-2 text-sm" required
                value="{{ $quotation->date }}" oninvalid="this.setCustomValidity('Tanggal penawaran harus diisi')"
        ...
        <div>
            ...
            <div class="mt-4 flex justify-end">
                <div class="bg-yellow-50 border border-yellow-300 rounded-lg px-5 py-3 text-right min-w-[220px]">
                    ...
                    <p class="text-lg font-bold text-gray-800" id="editGrandTotal-{{ $quotNum }}">Rp 0</p>
                </div>
            </div>
        </div>
