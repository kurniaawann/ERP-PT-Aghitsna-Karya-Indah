...
<x-modal id="addModal" title="Tambah Penawaran Aluminium" action="{{ route('aluminium-quotation.store') }}" method="POST"
    ...
    <div class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="recipient_address" class="w-full border border-border-strong rounded p-2 text-sm bg-surface-base text-text-input"
                value="Ditempat" maxlength="255"
                oninvalid="this.setCustomValidity('Alamat maksimal 255 karakter')"
                oninput="this.setCustomValidity('')">
        </div>
