...
<x-modal id="addModal" title="Tambah Penawaran Aluminium" action="{{ route('aluminium-quotation.store') }}" method="POST"
    ...
    <div class="space-y-5">
        ...
        <div>
            ...
            <select name="signed_by_id" class="w-full border border-border-strong rounded p-2 text-sm bg-surface-base text-text-input">
        ...
        <div>
            ...
            <select name="division_id" class="w-full border border-border-strong rounded p-2 text-sm bg-surface-base text-text-input">
