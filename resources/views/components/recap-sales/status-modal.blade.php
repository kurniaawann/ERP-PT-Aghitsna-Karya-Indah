...
<x-modal id="statusModal-{{ $sale->id_sales_recap }}" title="Update Status Pembayaran"
    action="{{ route('recap-sales.updateStatus', $sale->id_sales_recap) }}" method="POST" buttonText="Update Status">
    @method('PATCH')
