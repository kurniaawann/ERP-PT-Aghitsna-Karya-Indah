            ...
            <div class="p-6">
                @if ($employeesWithoutSalary->count() > 0)
                    <div class="mb-4">
                        <div class="flex items-center justify-between mb-3">
                            <span class="text-2xl font-bold text-amber-600">{{ $employeesWithoutSalary->count() }}</span>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-gray-600 font-medium">Semua Gaji Sudah Dibayarkan</p>
                        <p class="text-sm text-gray-500 mt-1">Tidak ada reminder gaji untuk bulan ini</p>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Tidak ada item dengan stok menipis</p>
                    </div>
                @endif
            </div>
        </div>
