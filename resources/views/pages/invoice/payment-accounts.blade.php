...
@section('content')
    <div class="bg-white p-4 sm:p-6 rounded-xl shadow">
        <h1 class="text-2xl font-semibold text-gray-700 mb-4">Rekening Pembayaran</h1>
        ...
        {{-- Table Component --}}
        @include('components.invoice.payment-accounts.table')
    ...
    {{-- Modal Tambah --}}
    @include('components.invoice.payment-accounts.add-modal')

    {{-- Modal Edit untuk setiap account --}}
    @foreach ($accounts as $account)
        @include('components.invoice.payment-accounts.edit-modal', ['account' => $account])
    @endforeach
