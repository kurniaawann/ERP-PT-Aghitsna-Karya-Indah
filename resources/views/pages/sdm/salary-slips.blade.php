{{-- =====================================================================
     Halaman: Slip Gaji (salary-slips)
     Tujuan: Halaman utama pengelolaan slip gaji karyawan bulanan
             (employment_type = bulanan). Menampilkan daftar slip dengan
             filter (bulan, tahun, pencarian), aksi bulk (Bayar/Hapus),
             generate slip per periode, dan cetak PDF (rekap / per slip).

     Data dari SalarySlipController@index:
...
@section('title', 'PT Aghitsna Karya Indah - Slip Gaji')
...
@section('content')
    <div class="bg-surface-base p-4 sm:p-6 rounded-xl shadow">
        {{-- ============================================================
             SECTION: Header
             ============================================================ --}}
        <h1 class="text-2xl font-semibold text-text-primary mb-4">Slip Gaji Karyawan Bulanan</h1>
