...
@section('title', 'PT Aghitsna Karya Indah - Reminder Jatuh Tempo ' . (auth()->user()?->isSuperAdmin() ? 'Invoice' : 'Invoice Proyek'))
                            ...
                            <tr>
                                <td colspan="9" class="px-6 py-8 text-center text-text-secondary">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p>Tidak ada data reminder {{ auth()->user()?->isSuperAdmin() ? 'invoice' : 'invoice proyek' }}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
