    ...
    <div class="bg-surface-base p-4 sm:p-6 rounded-xl shadow">
        ...
        <div class="mb-4 flex items-center justify-between flex-wrap gap-3">
            ...
            <form method="GET" action="{{ route('document-receipt.index') }}"
                ...
                <x-filters.search-input :value="request('search')" placeholder="Cari dokumen..." />
            </form>
            ...
            <div class="flex items-center gap-2 mt-2 min-[1280px]:mt-0 w-full min-[1280px]:w-auto">
                <div class="flex flex-col min-[1280px]:flex-row gap-2 w-full min-[1280px]:w-auto">
                    ...
                    {{-- Dropdown Export PDF --}}
                    <x-buttons.print-dropdown-with-selected :pdfRoute="route('document-receipt.export.pdf')" :queryParams="['search' => request('search')]" responsive="custom" fill />
