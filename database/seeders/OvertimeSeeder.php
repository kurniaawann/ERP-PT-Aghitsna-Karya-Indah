...
class OvertimeSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $octoberOvertimes = [
            // EMP001 - Ahmad Kurniawan (Manager) - Weekend overtime
            ['employee_id' => 'EMP001', 'date' => '2025-10-04', 'hours' => 3, 'rate' => 100000, 'notes' => 'Meeting dengan klien (Sabtu)'],
            ['employee_id' => 'EMP001', 'date' => '2025-10-11', 'hours' => 2.5, 'rate' => 100000, 'notes' => 'Presentasi proyek (Sabtu)'],
            ...
            ['employee_id' => 'EMP002', 'date' => '2025-10-12', 'hours' => 3.5, 'rate' => 80000, 'notes' => 'Training karyawan baru (Sabtu)'],
            ['employee_id' => 'EMP002', 'date' => '2025-10-26', 'hours' => 2, 'rate' => 80000, 'notes' => 'Evaluasi bulanan (Minggu)'],

            // EMP003 - Budi Santoso (Staff Admin)
            ['employee_id' => 'EMP003', 'date' => '2025-10-11', 'hours' => 1.5, 'rate' => 50000, 'notes' => 'Entry data (Sabtu)'],
            ['employee_id' => 'EMP003', 'date' => '2025-10-19', 'hours' => 2, 'rate' => 50000, 'notes' => 'Arsip dokumen (Minggu)'],

            // EMP005 - Eko Prasetyo (Staff Produksi)
            ['employee_id' => 'EMP005', 'date' => '2025-10-04', 'hours' => 3, 'rate' => 45000, 'notes' => 'Kejar target produksi (Sabtu)'],
            ['employee_id' => 'EMP005', 'date' => '2025-10-12', 'hours' => 2.5, 'rate' => 45000, 'notes' => 'Order mendesak (Sabtu)'],
            ['employee_id' => 'EMP005', 'date' => '2025-10-18', 'hours' => 4, 'rate' => 45000, 'notes' => 'Packing barang (Sabtu)'],

            // EMP008 - Hendra Gunawan (Staff IT)
            ['employee_id' => 'EMP008', 'date' => '2025-10-05', 'hours' => 3, 'rate' => 75000, 'notes' => 'Maintenance server (Minggu)'],
            ['employee_id' => 'EMP008', 'date' => '2025-10-18', 'hours' => 5, 'rate' => 75000, 'notes' => 'Update sistem (Sabtu)'],
        ...
        $novemberOvertimes = [
            // EMP001 - Ahmad Kurniawan
            ['employee_id' => 'EMP001', 'date' => '2025-11-01', 'hours' => 3, 'rate' => 100000, 'notes' => 'Rapat evaluasi (Sabtu)'],
            ['employee_id' => 'EMP001', 'date' => '2025-11-08', 'hours' => 2, 'rate' => 100000, 'notes' => 'Finalisasi proposal (Sabtu)'],
            ...
            ['employee_id' => 'EMP004', 'date' => '2025-11-01', 'hours' => 2, 'rate' => 60000, 'notes' => 'Event marketing (Sabtu)'],
            ['employee_id' => 'EMP004', 'date' => '2025-11-08', 'hours' => 3, 'rate' => 60000, 'notes' => 'Presentasi produk (Sabtu)'],
            ...
            // EMP008 - Hendra Gunawan
            ['employee_id' => 'EMP008', 'date' => '2025-11-01', 'hours' => 4, 'rate' => 75000, 'notes' => 'Implementasi fitur baru (Sabtu)'],
            ['employee_id' => 'EMP008', 'date' => '2025-11-08', 'hours' => 2.5, 'rate' => 75000, 'notes' => 'Bug fixing (Sabtu)'],
        ];
